  ...
  return (
    <div className='flex flex-col justify-center items-center py-10 md:py-20 px-6 md:px-40 overflow-hidden'>
            <div data-gsap="fade-up" className='text-center w-full'>
                <h1 className='text-4xl md:text-6xl font-bold text-center max-w-md mx-auto'>Form, fused with function.</h1>
                <p className='text-base md:text-[20px] text-[#6B7280] text-center max-w-lg mx-auto mt-4'>A revolutionary silhouette that contours naturally to your pet's neck, combining aerospace-grade materials with uncompromising aesthetics.</p>
            </div>
            <div data-gsap="fade-up" className='mt-10 md:mt-20 w-full flex justify-center'>
                <Image src={Lumina} width={1000} height={1000} alt="" className='w-full h-auto max-w-5xl rounded-[8px]' />
            </div>

            <div className='flex flex-col lg:flex-row justify-between items-center py-12 md:py-28 gap-10 lg:gap-20'>
                <div data-gsap="fade-up" className='flex flex-col justify-start text-center lg:text-left items-center lg:items-start'>
                ...
                <div data-gsap="fade-up" className='w-full '>
                    <Image src={Titanium} width={1000} height={1000} alt="" className='h-[500px] rounded-[8px]' />
                </div>
            </div>
            ...
            <div className='flex flex-col lg:flex-row-reverse justify-between items-center py-12 md:py-28 gap-10 lg:gap-20'>
                ...
                <div data-gsap="fade-up" className='w-full'>
                    <Image src={Band} width={1000} height={1000} alt="" className='h-[500px] rounded-[8px]' />
                </div>
            </div>
            ...
            <div className='py-20'>
                ...
                <div data-gsap="stagger" className='flex flex-col lg:flex-row justify-between items-center py-10 md:py-20 gap-10 lg:gap-20'>
                    <div className='bg-white w-full'>
                        <div className='flex flex-col justify-center items-center p-6 h-[470px]'>
                            <Image src={Obsidian} width={1000} height={1000} alt="" className='h-[500px] py-6 rounded-[8px]' />
                    ...
                    <div className='bg-white w-full'>
                        <div className='flex flex-col justify-center items-center p-6 h-[470px]'>
                            <Image src={Sandstone} width={1000} height={1000} alt="" className='h-[500px] py-6 rounded-[8px]' />
                    ...
                    <div className='bg-white w-full'>
                        <div className='flex flex-col justify-center items-center p-6 h-[470px]'>
                            <Image src={Forest} width={1000} height={1000} alt="" className='h-[500px] py-6 rounded-[8px]' />
